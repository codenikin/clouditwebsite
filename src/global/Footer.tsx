...
const FooterHome = () => {
  return (
    <>
      <footer className={`techin-footer-section1 section ${styles['bg-background']} `}>
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-12">
                <div className="techin-footer-textarea footer1">
                  ...
                  <p>
                    At Techin, we deliver innovative IT solutions to help businesses thrive,
                    offering customized strategies, robust support, and cutting-edge technology for
              ...
              <div className="col-xl-4 col-md-4">
                <div className="techin-footer-menu2 ml-60">
                  ...
                  <div className="techin-instagram-wrap">
                    ...
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio">
                        <img src="assets/images/footer/f4.png" alt="" />
                      </Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio">
                    ...
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio">
                        <img src="assets/images/footer/f5.png" alt="" />
                      </Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio">
                        <img src="assets/images/footer/f6.png" alt="" />
                      </Link>
                    </div>
                    <div className="techin-instagram-thumb">
                      <Link href="/portfolio">
              ...
              <a href="mailto:name@gmail.com">
                <div className="techin-footer-info-item">
                  ...
                  <div className="techin-footer-info-text info1">
                    ...
                    <h5>sales@clouditsolutions.in</h5>
                  </div>
                </div>
              </a>
          ...
          <div className="techin-footer-bottom bottom2">
            <div className="techin-copywright">
              <p>
                ...
                <span className="footer-text">Cloud IT solutions</span>. All rights reserved by{' '}
                <span className="footer-text">Cloud IT.</span>
              </p>
            </div>
